...
useEffect(() => {
  ...
  return (
    ...
    <Text style={styles.topLeftText}>Nearby Alerts</Text>
      ...
      <TouchableOpacity style={styles.backButton} onPress={() => Alert.alert('Add Alert', 'Functionality to add a new alert goes here.')}>
        <Text style={styles.backButtonText}>+ Add Alert</Text>
      </TouchableOpacity>
